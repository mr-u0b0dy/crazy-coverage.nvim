...
├── math_utils.hpp     # Math utility header
...
- Basic arithmetic operations (all covered)
- Error handling with exceptions (partially covered)
- Power calculation with loops (all covered)
- Intentionally uncovered code paths for demonstration:
